                      ...
                      onPressed: () async {
                        if (_formKey.currentState!.validate()) {
                          if (dropDownValue == 'Scheduled-Task') {
                            ...
                            final minutes =
                                currentDate.minute - DateTime.now().minute;
                            Provider.of<Tasks>(context, listen: false)
                                .addScheduled(intChosen, _titleController.text,
                                    currentDate, '',
                          ...
                          if (dropDownValue == 'Recurring-Task') {
                            ...
                            if (remindDropDownValue == 0) {
                              for (int i = 0; i < 48; i++) {
                                dynamicTime =
                                    dynamicTime.add(Duration(minutes: 30));
                                if (dynamicTime.hour <
                                  ...
                                  final days =
                                      dynamicTime.day - DateTime.now().day;
                                  final hours =
                                      dynamicTime.hour - DateTime.now().hour;
                                  final minutes = dynamicTime.minute -
                                      DateTime.now().minute;
                                  listOfNotifTimes.add(
                                      ListOfNotif(_intChosen, dynamicTime));
